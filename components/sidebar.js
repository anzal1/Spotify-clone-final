...
import { playlistIdState } from "../atoms/paylistatom";
...
function Sidebar() {
  ...
  return (
    <div
     ...
     border-r border-gray-900 overflow-y-scroll scrollbar-hide h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36"
    >
